...
const About = () => {
  return (
    ...
    >
      <h2 className="text-4xl font-bold text-white mb-12 border-b-2 border-purple-500 pb-2">
        About Me
      </h2>
      ...
      <div className="max-w-3xl bg-white/5 border border-white/10 p-10 rounded-3xl backdrop-blur-md shadow-2xl">
        ...
        <p className="text-gray-300 leading-relaxed text-lg mb-6">
          ...
          mysterious land of backend development where bugs go to multiply.
          Full-stack dreams, coffee-fueled nights, and lots of console.log.
        </p>
