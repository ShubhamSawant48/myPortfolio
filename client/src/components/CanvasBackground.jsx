...
export default function CanvasBackground({
  ...
  useEffect(() => {
    ...
    const layers = [
      {
        ...
        blur: 100,
        alpha: 0.6,
        size: 0.7, // relative to max dimension
        base: { x: 0.62, y: 0.22 },
        stops: [
      ...
      },
      {
        ...
        stops: [
          ...
          { s: 0.3, c: "rgba(96,30,180,0.88)" },
          { s: 0.55, c: "rgba(50,20,110,0.6)" },
          { s: 0.7, c: "rgba(0,0,0,0.0)" },
        ],
        roam: {
          ampX: 6,
          ampY: 12,
    ...
    function drawLayer(layer, t) {
      ...
      const rx =
        Math.sin(t * layer.roam.speed + layer.roam.phase) * layer.roam.ampX;
      const ry =
        Math.cos(t * (layer.roam.speed * 1.25) + layer.roam.phase * 1.1) *
        layer.roam.ampY;
